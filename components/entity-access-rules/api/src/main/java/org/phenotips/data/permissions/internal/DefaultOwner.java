...
/**
 * Default implementation of the {@link Owner} interface, making use of a {@link PermissionsHelper} component for any
...
public class DefaultOwner implements Owner
{
    ...
    public DefaultOwner(EntityReference user, PermissionsHelper helper)
    {
        this.user = user;
        this.helper = helper;
    }

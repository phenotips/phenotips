...
public interface AccessHelper
{
    ...
    /**
     * Get the {@link Optional<AccessLevel>} access level from its {@code name}.
     *
    ...
    /**
     * Returns true iff {@link PermissionsHelper#getCurrentUser() the current user} has administrative access level,
     * false otherwise.
     *

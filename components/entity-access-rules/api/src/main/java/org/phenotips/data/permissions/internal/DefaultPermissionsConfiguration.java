...
public class DefaultPermissionsConfiguration implements PermissionsConfiguration
{
    ...
    {
        DocumentReference preferencesDocument = this.resolver.resolve(PermissionsConfiguration.PREFERENCES_DOCUMENT);
        DocumentReference configurationClassDocument = this.resolver.resolve(
            PermissionsConfiguration.VISIBILITY_CONFIGURATION_CLASS_REFERENCE);

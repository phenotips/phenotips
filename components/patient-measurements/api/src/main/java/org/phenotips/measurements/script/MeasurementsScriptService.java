...
public class MeasurementsScriptService implements ScriptService
{
    ...
    public List<MeasurementHandler> getAvailableMeasurementHandlers()
    {
        try {
            ...
            Collections.sort(result, this.measurementHandlersSorter.getMeasurementHandlerComparator());
            return result;
        } catch (ComponentLookupException ex) {
    ...
    public Set<String> getAvailableMeasurementNames()
    {
        try {
            ...
            if (handlers != null) {
                Set<String> result = new TreeSet<>(this.measurementHandlersSorter.getMeasurementNameComparator());

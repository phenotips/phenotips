...
/**
 * Tests for the {@link InternippleDistanceMeasurementHandler} component, and a few methods from the base @{link
 * {@link AbstractMeasurementHandler} class.
 *
 * @version $Id$
 * @since 1.4
 */
public class InternippleDistanceTest
{
    @Rule
    public final MockitoComponentMockingRule<MeasurementHandler> mocker =
        new MockitoComponentMockingRule<MeasurementHandler>(InternippleDistanceMeasurementHandler.class);

    private InternippleDistanceMeasurementHandler getComponent() throws ComponentLookupException
    {
        return (InternippleDistanceMeasurementHandler) this.mocker.getComponentUnderTest();
    }

    @Test
    public void nameIsIND() throws ComponentLookupException
    {
        Assert.assertSame("ind", getComponent().getName());
    }

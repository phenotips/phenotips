...
public class ShareProtocol
{
    ...
    /** version 1.2: new date format in patient JSON + new genes + new prenatal features format */
    ...
    public static final String CLIENT_POST_KEY_NAME_USER_TOKEN = "user_login_token"; // if user_token is provided
                                                                                     // password is ignored

    // possible ACTION key values are:
    public static final String CLIENT_POST_ACTIONKEY_VALUE_INFO = "get_server_info"; // get patient data fields
                                                                                     // supported by the server and
                                                                                     // remote user groups

    public static final String CLIENT_POST_ACTIONKEY_VALUE_STATE = "get_patient_state"; // get the state of a patient
                                                                                        // record

    public static final String CLIENT_POST_ACTIONKEY_VALUE_PUSH = "push"; // push the patient

    public static final String CLIENT_POST_ACTIONKEY_VALUE_GETID = "get_patient_id"; // get remote ID and remote URL of
                                                                                     // the patient object with the
                                                                                     // given GUID
    ...
    public static final String CLIENT_POST_KEY_NAME_GROUPNAME = "groupname"; // if provided, the ownership of the newly
                                                                             // created patient object will be
                                                                             // transferred to this group

    public static final String CLIENT_POST_KEY_NAME_GUID = "patient_guid"; // if provided, the existing remote patient
                                                                           // object with the given GUID will be
                                                                           // updated.
                                                                           // an error will be returned if updating is
                                                                           // disabled or GUID is incorrect or the
                                                                           // patient object
                                                                           // referenced does not belong to the given
                                                                           // user and/or group (if provided)

    public static final String CLIENT_POST_KEY_NAME_PATIENTSTATE = "patient_state";

    public static final String CLIENT_POST_KEY_NAME_PATIENTSTATE_CONSENTS = "consents"; // key name which can exist
                                                                                        // within the patient state JSON
    ...
    public static final String SERVER_JSON_KEY_NAME_ERROR_UNTRUSTEDSERVER = "unauthorized_server"; // unapproved source
                                                                                                   // server

    public static final String SERVER_JSON_KEY_NAME_ERROR_EXPIREDUSERTOKEN = "user_token_expired";

    public static final String SERVER_JSON_KEY_NAME_ERROR_NOUSERTOKENS = "user_tokens_not_supported"; // user_tokens are
                                                                                                      // disabled on the
                                                                                                      // server (in case
                                                                                                      // a token is
                                                                                                      // provided)
    ...
    public static final String SERVER_JSON_KEY_NAME_ERROR_INCORRECTGROUP = "incorrect_user_group"; // user group
                                                                                                   // supplied either
                                                                                                   // does not exist or
                                                                                                   // user is not in the
                                                                                                   // group

    public static final String SERVER_JSON_KEY_NAME_ERROR_UPDATESDISABLED = "updates_disabled"; // in case GUID is
                                                                                                // provided in the
                                                                                                // request and updating
                                                                                                // is disabled on the
                                                                                                // server

    public static final String SERVER_JSON_KEY_NAME_ERROR_INCORRECTGUID = "incorrect_guid"; // GUID provided in the
                                                                                            // request does not
                                                                                            // represents a patient
                                                                                            // document

    public static final String SERVER_JSON_KEY_NAME_ERROR_GUIDACCESSDENIED = "guid_access_denied"; // GUID provided in
                                                                                                   // the request
                                                                                                   // represents a
                                                                                                   // document which is
                                                                                                   // not
    ...
    public static final String SERVER_JSON_KEY_NAME_ERROR_MISSINGCONSENT = "missing_consent"; // if any of the required
                                                                                              // consents are missing
    ...
    public static final String SERVER_JSON_PUSH_KEY_NAME_PATIENTID = "patient_id"; // ID of the patient (either updated
                                                                                   // or newly created)

    public static final String SERVER_JSON_PUSH_KEY_NAME_PATIENTURL = "patient_url"; // URL of the patient (either
                                                                                     // updated or newly created)

    public static final String SERVER_JSON_PUSH_KEY_NAME_PATIENTGUID = "patient_guid"; // GUID of the patient object on
                                                                                       // the remote server which can be
                                                                                       // used to link to the
                                                                                       // patient from the remote server
                                                                                       // and/or to update the patient
                                                                                       // later

    /**
     * Helper class describing an incompatibility between serializers in two different PhenoTips versions. An
     * incommpatibility is described in terms of a "controlling field name" which triggers (part of) a serializer when
     * serializing a patient to JSON, i.e. one incompatibility is limited to one field name. An alternative
     * "deprecated field name" may be specified, which is supposed to trigger an certain old serializer.
     */

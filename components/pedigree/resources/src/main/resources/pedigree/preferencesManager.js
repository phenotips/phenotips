    ...
    var PreferencesManager = Class.create( {
        ...
        load: function(callWhenReady) {
            ...
            if (numConfigs > 0) {
                ...
                this.preferences.global.useGradientOnNodes           = ("$!{xwiki.getDocument('XWiki.XWikiPreferences').getObject('PhenoTips.PedigreeGlobalSettings').getProperty('uiGradientNodes').value}" == "1");
            }
        ...
        onPreferencesAvailable : function(response) {
            ...
            console.log("Loaded global preferences: " + Helpers.stringifyObject(this.preferences.global));
        },

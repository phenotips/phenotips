        ...
        generateAliveWell: function() {
            ...
            for (var index = 0; index < buttons.length; index++) {
                ...
                if (lifeStatus == buttons[index].lifeStatus) {
                    ...
                    this.getNode().getGraphics().updateAliveAndWellGraphic(awStatus);
                }
                ...
                rect.click(function(i) {
                    ...
                    var properties = {};
                    buttons[i].hasOwnProperty("aw") && (properties["setAliveAndWell"] = buttons[i].aw) && this.getNode().getGraphics().updateAliveAndWellGraphic(buttons[i].aw);

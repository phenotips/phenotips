define([], function(){
  ...
  * @param {alwayEnabled} Boolean indicating whether this input should be enabled at all times
  */
  var AbstractFuzzyDateInput = Class.create({
    initialize : function(element, alwaysEnabled){
      ...
      //The isFuzzy boolean specifies whether the value contained in the input is specific or fuzzy(a range, decade etc.). Blank and invalid values are not fuzzy.
      this.isFuzzy = false;
      this.isValid = true;
  ...
  * @constructor
  * @param {element} A text input element. The behaviour of the element will be modified.
  * @param {decadesEnabled} Boolean indicating whether decades are supported.
  */

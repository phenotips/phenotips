 ...
 */
@Component
@Named("family-contains-person/secure")
@Singleton
public class SecureFamilyContainsPersonConnectionsManager
    extends AbstractSecureOutgoingPrimaryEntityConnectionsManager<Family, Person>

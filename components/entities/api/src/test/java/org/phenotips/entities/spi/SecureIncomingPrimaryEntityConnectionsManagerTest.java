...
/**
 * Unit tests for {@link AbstractSecureIncomingPrimaryEntityConnectionsManager}.
 */
public class SecureIncomingPrimaryEntityConnectionsManagerTest
{
    ...
    public final MockitoComponentMockingRule<PrimaryEntityConnectionsManager<Person, Family>> mocker =
        new MockitoComponentMockingRule<>(SecurePersonBelongsToFamilyConnectionsManager.class);
    ...
    @Test
    public void connectAllConnectsEveryAccessibleFamily() throws XWikiException
    {
        grantAccessExcept2();
    ...
    @Test
    public void connectFromAllConnectsEveryAccessiblePatient() throws XWikiException
    {
        grantAccessExcept2();
    ...
    @Test
    public void disconnectAllDisconnectsEveryAccessibleFamily() throws XWikiException
    {
        grantAccessTo1();
        ...
        Mockito.verifyZeroInteractions(this.family2Doc, this.family3Doc);
    ...
    public void getAllConnectionsReturnsEmptyListForInaccessibleSubject()
    {
        ...
        Mockito.verifyZeroInteractions(this.qm, this.reverseConnectionsQuery, this.xwiki, this.family1);
    }

...
/**
 * Unit tests for {@link AbstractIncomingPrimaryEntityConnectionsManager}.
 */
public class IncomingPrimaryEntityConnectionsManagerTest
{
    ...
    @Rule
    public final MockitoComponentMockingRule<PrimaryEntityConnectionsManager<Person, Family>> mocker =
        new MockitoComponentMockingRule<>(PersonBelongsToFamilyConnectionsManager.class);

    private PrimaryEntityConnectionsManager<Person, Family> manager;
    ...
    public void setUp() throws Exception
    {
        ...
        when(this.family1Doc.newXObject(AbstractIncomingPrimaryEntityConnectionsManager.INCOMING_CONNECTION_XCLASS,
        ...
        when(this.family2Doc.newXObject(AbstractIncomingPrimaryEntityConnectionsManager.INCOMING_CONNECTION_XCLASS,
        ...
        when(this.family3Doc.newXObject(AbstractIncomingPrimaryEntityConnectionsManager.INCOMING_CONNECTION_XCLASS,
        ...
        when(this.connectionsQuery.execute()).thenReturn(Collections.singletonList("Families.F01"));
    ...
    {
        this.manager.connect(null, this.family1);
    }

    @Test(expected = IllegalArgumentException.class)
    public void connectWithNullObjectThrowsException() throws Exception
    {
        this.manager.connect(this.person1, null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void connectWithNoDocumentObjectThrowsException() throws Exception
    {
        when(this.family1.getXDocument()).thenReturn(null);
        this.manager.connect(this.person1, this.family1);
    }

    @Test(expected = IllegalArgumentException.class)
    public void connectWithNoReferenceSubjectThrowsException() throws Exception
    {
    ...
    public void connectStoresConnectionInTheObject() throws XWikiException
    {
        ...
        verify(this.family1Doc).newXObject(AbstractIncomingPrimaryEntityConnectionsManager.INCOMING_CONNECTION_XCLASS,
            this.xcontext);
        verify(this.connection1Obj).setStringValue(AbstractIncomingPrimaryEntityConnectionsManager.REFERENCE_XPROPERTY,
    ...
    {
        when(this.family1Doc.getXObject(AbstractIncomingPrimaryEntityConnectionsManager.INCOMING_CONNECTION_XCLASS,
            AbstractIncomingPrimaryEntityConnectionsManager.REFERENCE_XPROPERTY,
            PERSON1_SERIALIZED_REFERENCE, false)).thenReturn(this.connection1Obj);
        Assert.assertTrue(this.manager.connect(this.person1, this.family1));
        verify(this.family1Doc, Mockito.never()).newXObject(
            AbstractIncomingPrimaryEntityConnectionsManager.INCOMING_CONNECTION_XCLASS,
            this.xcontext);
    ...
    {
        Assert
            .assertTrue(this.manager.connectAll(this.person1, Arrays.asList(this.family1, this.family2, this.family3)));
    ...
    public void connectAllReturnsFalseOnAnyFailureAndCreatesAllOtherConnections() throws XWikiException
    {
        ...
        Assert.assertFalse(
            this.manager.connectAll(this.person1, Arrays.asList(this.family1, this.family2, this.family3)));
    ...
    {
        Assert.assertTrue(this.manager.connectAll(this.person1, Collections.emptyList()));
    }

    @Test
    public void connectAllIgnoresNullList() throws XWikiException
    {
        Assert.assertTrue(this.manager.connectAll(this.person1, null));
    }

    @Test
    public void connectAllIgnoresAllNullList() throws XWikiException
    {
        Assert.assertTrue(this.manager.connectAll(this.person1, Arrays.asList(null, null)));
    }

    @Test(expected = IllegalArgumentException.class)
    public void connectAllWithNullSubjectThrowsException()
    {
        this.manager.connectAll(null, Arrays.asList(this.family1));
    }
    ...
    {
        Assert.assertTrue(
            this.manager.connectFromAll(Arrays.asList(this.person1, this.person2, this.person3), this.family1));
    ...
    {
        Assert.assertTrue(
            this.manager.connectFromAll(Arrays.asList(null, this.person1, null, this.person2, null), this.family1));
    ...
    {
        Assert.assertTrue(this.manager.connectFromAll(Collections.emptyList(), this.family1));
    }

    @Test
    public void connectFromAllIgnoresNullList() throws XWikiException
    {
        Assert.assertTrue(this.manager.connectFromAll(null, this.family1));
    }

    @Test
    public void connectFromAllIgnoresAllNullList() throws XWikiException
    {
        Assert.assertTrue(this.manager.connectFromAll(Arrays.asList(null, null), this.family1));
    }

    @Test(expected = IllegalArgumentException.class)
    public void connectFromAllWithNullObjectThrowsException()
    {
        this.manager.connectFromAll(Arrays.asList(this.person1), null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void disconnectWithNullSubjectThrowsException() throws Exception
    {
        this.manager.disconnect(null, this.family1);
    }

    @Test(expected = IllegalArgumentException.class)
    public void disconnectWithNullObjectThrowsException() throws Exception
    {
        this.manager.disconnect(this.person1, null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void disconnectWithNoDocumentObjectThrowsException() throws Exception
    {
        when(this.family1.getXDocument()).thenReturn(null);
        this.manager.disconnect(this.person1, this.family1);
    }

    @Test(expected = IllegalArgumentException.class)
    public void disconnectWithNoReferenceSubjectThrowsException() throws Exception
    {
        when(this.person1.getDocumentReference()).thenReturn(null);
        this.manager.disconnect(this.person1, this.family1);
    }
    ...
    public void disconnectDeletesConnectionFromTheObject() throws XWikiException
    {
        ...
        Assert.assertTrue(this.manager.disconnect(this.person1, this.family1));

        verify(this.family1Doc).getXObject(AbstractIncomingPrimaryEntityConnectionsManager.INCOMING_CONNECTION_XCLASS,
            AbstractIncomingPrimaryEntityConnectionsManager.REFERENCE_XPROPERTY,
    ...
    public void disconnectAllDisonnectsEveryFamily() throws XWikiException
    {
        when(this.family1Doc.getXObject(AbstractIncomingPrimaryEntityConnectionsManager.INCOMING_CONNECTION_XCLASS,
            AbstractIncomingPrimaryEntityConnectionsManager.REFERENCE_XPROPERTY,
            PERSON1_SERIALIZED_REFERENCE, false)).thenReturn(this.connection1Obj);
        when(this.family2Doc.getXObject(AbstractIncomingPrimaryEntityConnectionsManager.INCOMING_CONNECTION_XCLASS,
            AbstractIncomingPrimaryEntityConnectionsManager.REFERENCE_XPROPERTY,
            PERSON1_SERIALIZED_REFERENCE, false)).thenReturn(this.connection2Obj);
        when(this.family3Doc.getXObject(AbstractIncomingPrimaryEntityConnectionsManager.INCOMING_CONNECTION_XCLASS,
            AbstractIncomingPrimaryEntityConnectionsManager.REFERENCE_XPROPERTY,
            PERSON1_SERIALIZED_REFERENCE, false)).thenReturn(this.connection3Obj);

        Assert
            .assertTrue(
                this.manager.disconnectAll(this.person1, Arrays.asList(this.family1, this.family2, this.family3)));

        verify(this.family1Doc).removeXObject(this.connection1Obj);
        verify(this.family2Doc).removeXObject(this.connection2Obj);
        ...
        verify(this.xwiki).saveDocument(this.family2Doc, REMOVE_COMMENT, true, this.xcontext);
    ...
    public void disconnectAllSkipsNull() throws XWikiException
    {
        ...
        Assert.assertTrue(
            this.manager.disconnectAll(this.person1, Arrays.asList(null, this.family1, null, this.family2)));
    ...
    {
        Assert.assertTrue(this.manager.disconnectAll(this.person1, Collections.emptyList()));
    }

    @Test
    public void disconnectAllIgnoresNullList() throws XWikiException
    {
        Assert.assertTrue(this.manager.disconnectAll(this.person1, null));
    }

    @Test
    public void disconnectAllIgnoresAllNullList() throws XWikiException
    {
        Assert.assertTrue(this.manager.disconnectAll(this.person1, Arrays.asList(null, null)));
    }

    @Test(expected = IllegalArgumentException.class)
    public void disconnectAllWithNullSubjectThrowsException()
    {
        this.manager.disconnectAll(null, Arrays.asList(this.family1));
    }
    ...
    {
        when(this.connectionsQuery.execute()).thenReturn(Arrays.asList("Families.F01", "Families.F02", "Families.F03"));
        when(this.family1Doc.getXObject(AbstractIncomingPrimaryEntityConnectionsManager.INCOMING_CONNECTION_XCLASS,
            AbstractIncomingPrimaryEntityConnectionsManager.REFERENCE_XPROPERTY,
            PERSON1_SERIALIZED_REFERENCE, false)).thenReturn(this.connection1Obj);
        when(this.family2Doc.getXObject(AbstractIncomingPrimaryEntityConnectionsManager.INCOMING_CONNECTION_XCLASS,
        ...
        Assert.assertFalse(this.manager.disconnectAll(this.person1));
    ...
    public void disconnectObjectRemovesAllConnections() throws XWikiException
    {
        ...
        Assert.assertTrue(this.manager.disconnectFromAll(this.family1));
        ...
        throws XWikiException, QueryException
    {
        when(this.reverseConnectionsQuery.execute())
            .thenReturn(Arrays.asList("Persons.P01", "Persons.P02", "Persons.P03"));
        when(this.family1Doc.getXObject(AbstractIncomingPrimaryEntityConnectionsManager.INCOMING_CONNECTION_XCLASS,
            AbstractIncomingPrimaryEntityConnectionsManager.REFERENCE_XPROPERTY,
            PERSON1_SERIALIZED_REFERENCE, false)).thenReturn(this.connection1Obj);
        when(this.family1Doc.getXObject(AbstractIncomingPrimaryEntityConnectionsManager.INCOMING_CONNECTION_XCLASS,
        ...
        Mockito.doThrow(new XWikiException()).when(this.xwiki).saveDocument(this.family1Doc,
            "Removed connection to main:Persons.P02",
            true, this.xcontext);
    ...
    {
        Collection<Family> result = this.manager.getAllConnections(this.person1);
    ...
    {
        Collection<Person> result = this.manager.getAllReverseConnections(this.family1);
        Assert.assertNotNull(result);
        Assert.assertEquals(1, result.size());
    ...
    {
        Assert.assertFalse(this.manager.isConnected(null, this.family1));
    }

    @Test
    public void isConnectedWithNullObjectReturnsFalse()
    {
        Assert.assertFalse(this.manager.isConnected(this.person1, null));
    }

    @Test
    public void isConnectedWorks()
    {
        Assert.assertTrue(this.manager.isConnected(this.person1, this.family1));
        Assert.assertFalse(this.manager.isConnected(this.person2, this.family3));
    }

    @Test
    public void getWithSingleConnectionReturnsConnectedFamily()
    {
        Assert.assertSame(this.family1, this.manager.get(this.person1));
    }
    ...
    {
        when(this.connectionsQuery.execute()).thenReturn(Arrays.asList("Families.F01", "Families.F02"));
        Assert.assertNull(this.manager.get(this.person1));
    }
    ...
    {
        when(this.connectionsQuery.execute()).thenReturn(Arrays.asList("Families.F02", "Families.F03"));
        ...
        Assert.assertTrue(this.manager.set(this.person1, this.family1));
    ...
    public void setDeletesPreviousConnectionsButStopsOnFailure() throws QueryException, XWikiException
    {
        ...
        when(this.family3Doc.getXObject(AbstractIncomingPrimaryEntityConnectionsManager.INCOMING_CONNECTION_XCLASS,
            ...
            PERSON1_SERIALIZED_REFERENCE, false)).thenReturn(this.connection3Obj);
        Mockito.doThrow(new XWikiException()).when(this.xwiki).saveDocument(this.family2Doc,
            REMOVE_COMMENT, true, this.xcontext);

        Assert.assertFalse(this.manager.set(this.person1, this.family1));
    ...
    {
        this.manager.set(null, this.family1);
    }

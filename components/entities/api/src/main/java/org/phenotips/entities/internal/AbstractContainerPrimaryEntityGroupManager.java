...
/**
 * Base class for implementing specific entity group managers, where the groups are of the
 * {@link AbstractContainerPrimaryEntityGroup container type}. This can be used as an almost complete base

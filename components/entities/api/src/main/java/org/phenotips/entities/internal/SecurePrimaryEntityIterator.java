...
public class SecurePrimaryEntityIterator<E extends PrimaryEntity> implements Iterator<E>
{
    ...
    private Constructor<? extends E> secureConstructor;
     ...
     */
    public SecurePrimaryEntityIterator(Iterator<E> internalIterator, AuthorizationService authorizationService,
        User currentUser,
        Constructor<? extends E> secureConstructor)
    {

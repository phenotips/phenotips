 ...
 * @since 1.0M10
 */
public class AllFarmUsersGroup extends AbstractGroup
{
    /**
     * Constructor.
     * 
     ...
     */
    public AllFarmUsersGroup(DocumentReference profileReference, EntityReferenceSerializer<String> serializer)
    {

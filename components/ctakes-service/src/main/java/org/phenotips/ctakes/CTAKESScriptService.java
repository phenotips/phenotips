...
@Named("ctakes")
@Singleton
public class CTAKESScriptService implements ScriptService 
{
	...
	public Map<String,ExtractedTerm> extract(String input) throws ResourceInitializationException, AnalysisEngineProcessException  {
		...
		try{
			...
			AnalysisEngine analysisEngine = AnalysisEngineFactory.createAggregate(analysisEngineDescriptionList,componentNames, null, null, null);
			System.out.println(Runtime.getRuntime().freeMemory());

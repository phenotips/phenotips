    ...
    public void initialize() throws InitializationException
    {
        ...
        try{
           ...
           //Chunker
        	...
        	ExternalResourceDescription dictionaryERD3 = ExternalResourceFactory.createExternalResourceDescription("RxnormIndex", org.apache.ctakes.core.resource.LuceneIndexReaderResourceImpl.class,"", "UseMemoryIndex",true,"IndexDirectory",new File("webapps/phenotips/resources/cTAKES/DictionaryLookup/drug_index").toURI().toURL().toString());
        	ExternalResourceDescription dictionaryERD4 = ExternalResourceFactory.createExternalResourceDescription("OrangeBookIndex", org.apache.ctakes.core.resource.LuceneIndexReaderResourceImpl.class,"" ,"UseMemoryIndex",true,"IndexDirectory",new File("webapps/phenotips/resources/cTAKES/DictionaryLookup/OrangeBook").toURI().toURL().toString());

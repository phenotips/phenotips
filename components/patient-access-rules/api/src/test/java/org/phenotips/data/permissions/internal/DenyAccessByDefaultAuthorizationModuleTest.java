...
public class DenyAccessByDefaultAuthorizationModuleTest
{
    ...
    @Test
    public void documentAccessIsDeniedOnPatients() throws ComponentLookupException
    {
    ...
    @Test
    public void documentAccessIsDeniedForGuestsOnPatients() throws ComponentLookupException
    {

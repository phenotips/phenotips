...
public class OwnerAccessLevelTest
{
    ...
    {
        Assert.assertEquals("owner", this.mocker.getComponentUnderTest().getName());
    }
    ...
    @Test
    public void grantsManageRight() throws ComponentLookupException
    {
        Assert.assertSame(ManageRight.MANAGE, this.mocker.getComponentUnderTest().getGrantedRight());
    }
    ...
    {
        TranslationManager tm = this.mocker.getInstance(TranslationManager.class);
        when(tm.translate("phenotips.permissions.accessLevels.owner.label")).thenReturn("Owner");
        Assert.assertEquals("Owner", this.mocker.getComponentUnderTest().getLabel());
    }
    ...
    {
        TranslationManager tm = this.mocker.getInstance(TranslationManager.class);
        when(tm.translate("phenotips.permissions.accessLevels.owner.description"))
            .thenReturn("Is the current owner of the patient data");
        Assert.assertEquals("Is the current owner of the patient data", this.mocker.getComponentUnderTest()
            .getDescription());
    }
    ...
    {
        Assert.assertEquals("owner", this.mocker.getComponentUnderTest().toString());
    }
    ...
    public void equalsTest() throws ComponentLookupException
    {
        ...
        when(other.getName()).thenReturn("owner", "view");

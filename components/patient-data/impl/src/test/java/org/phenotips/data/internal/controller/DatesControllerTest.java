...
public class DatesControllerTest
{
    ...
    public void loadPrioritizesDateAsEntered() throws ComponentLookupException
    {
        ...
        PhenoTipsDate deathDate = new PhenoTipsDate(JSONObject.fromObject("{'year': 1990, 'month': 11, 'day': 2}"));
        PhenoTipsDate birthDate = new PhenoTipsDate(JSONObject.fromObject("{'year': 2000, 'range': {'years': 10}}"));
    ...
    public void loadWorksWithDeprecatedDateFormats() throws ComponentLookupException
    {
        ...
        PhenoTipsDate deathDateDeprecated = new PhenoTipsDate(JSONObject.fromObject("{'decade': '1990s'}"));
        PhenoTipsDate deathDate = new PhenoTipsDate(JSONObject.fromObject("{'year': 1990, 'range': {'years': 10}}"));

        PhenoTipsDate birthDateDeprecated = new PhenoTipsDate(
                JSONObject.fromObject("{'decade': '1990s', 'year': '1990', 'month': '10'}"));
        PhenoTipsDate birthDate = new PhenoTipsDate(JSONObject.fromObject("{'year': 1990, 'month': 10}"));
    ...
    public void saveCorrectlyHandlesNullData() throws ComponentLookupException
    {
        ...
        doReturn(DatesController.PHENOTIPS_TO_JSON_FIELDNAMES.keySet().iterator()).when(this.dateData).keyIterator();
    ...
    public void saveCorrectlyHandlesNoData() throws ComponentLookupException
    {
        doReturn(this.dateData).when(this.patient).getData(DATA_NAME);
        doReturn(true).when(this.dateData).isNamed();
        doReturn(Collections.emptyIterator()).when(this.dateData).keyIterator();
    ...
    public void saveAddsAllDates() throws XWikiException, ComponentLookupException
    {
        ...
        PhenoTipsDate examDate = new PhenoTipsDate(JSONObject.fromObject("{'year': 1990, 'range': {'years': 10}}"));
    ...
    public void writeJSONAddsAllDates() throws ComponentLookupException
    {
        ...
        PhenoTipsDate examDate = new PhenoTipsDate(
                JSONObject.fromObject("{'year': 1990, 'month': 11, 'day': 2, 'range': {'years': 10}}"));
        datesMap.put(DatesController.PATIENT_DATEOFBIRTH_FIELDNAME, birthDate);
        datesMap.put(DatesController.PATIENT_DATEOFDEATH_FIELDNAME, deathDate);
        datesMap.put(DatesController.PATIENT_EXAMDATE_FIELDNAME, examDate);
        PatientData<PhenoTipsDate> datesData = new DictionaryPatientData<>(DATA_NAME, datesMap);
        ...
        Assert.assertEquals(this.dateFormat.format(birthDate.toEarliestPossibleISODate()),
            json.getString(DatesController.PATIENT_DATEOFBIRTH_FIELDNAME));
        Assert.assertEquals(this.dateFormat.format(deathDate.toEarliestPossibleISODate()),
            json.getString(DatesController.PATIENT_DATEOFDEATH_FIELDNAME));
        Assert.assertEquals(this.dateFormat.format(examDate.toEarliestPossibleISODate()),
            json.getString(DatesController.PATIENT_EXAMDATE_FIELDNAME));
    }
    ...
    public void writeJSONWithSelectedFieldsAddsAllSelectedDates() throws ComponentLookupException
    {
        ...
        PhenoTipsDate birthDate = new PhenoTipsDate("1990s-11-12");
        PhenoTipsDate deathDate = new PhenoTipsDate(new Date(999999999));
        PhenoTipsDate examDate = new PhenoTipsDate(JSONObject.fromObject("{'year': 1990, 'month': 11 }"));
        datesMap.put(DatesController.PATIENT_DATEOFBIRTH_FIELDNAME, birthDate);
        datesMap.put(DatesController.PATIENT_DATEOFDEATH_FIELDNAME, deathDate);
        datesMap.put(DatesController.PATIENT_EXAMDATE_FIELDNAME, examDate);
        PatientData<PhenoTipsDate> datesData = new DictionaryPatientData<>(DATA_NAME, datesMap);
    ...
    {
        JSONObject json = new JSONObject();
        PhenoTipsDate examDate = new PhenoTipsDate(JSONObject.fromObject("{'year': 800, 'range': {'years': 100}}"));
    ...
    public void readJSONReturnsAllDates() throws ComponentLookupException
    {
        ...
        PhenoTipsDate deathDate = new PhenoTipsDate(new Date(999999999));
        PhenoTipsDate examDate = new PhenoTipsDate(JSONObject.fromObject("{'year': 1990, 'month': 11, day: 6}"));
        ...
        PhenoTipsDate birthDateOldStyle = new PhenoTipsDate(JSONObject.fromObject("{'decade': '1990s'}"));
        PhenoTipsDate deathDateOldStyle = new PhenoTipsDate(JSONObject.fromObject("{'decade': '1990s', 'year': '1995'}"));

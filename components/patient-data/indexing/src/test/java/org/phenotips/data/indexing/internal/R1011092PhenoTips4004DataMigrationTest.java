...
public class R1011092PhenoTips4004DataMigrationTest
{
    @Rule
    public MockitoComponentMockingRule<HibernateDataMigration> mocker =
        new MockitoComponentMockingRule<>(R1011092PhenoTips4004DataMigration.class, HibernateDataMigration.class);
    ...
    {
        Assert.assertEquals(1011092, this.mocker.getComponentUnderTest().getVersion().getVersion());
    }

...
public class GeneNomenclatureTest
{
    ...
    public void setUp() throws ComponentLookupException, IOException, SolrServerException
    {
        ...
        when(this.termDoc.getFieldValues(ID_LABEL)).thenReturn(Collections.<Object>singletonList(TERM_ID));
        when(this.termDoc.getFieldValues(NAME_LABEL)).thenReturn(Collections.<Object>singletonList(TERM_NAME));

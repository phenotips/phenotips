...
public class DefaultUsersResourceImpl extends XWikiResource implements UsersResource
{
     ...
     */
    @Override
    public Response searchUsersAndGroups(String input, boolean searchUsers, boolean searchGroups)
    {
        ...
        JSONObject json = this.usersAndGroups.search(input, searchUsers, searchGroups);

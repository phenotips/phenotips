...
public interface FamilyRepository
{
     ...
     * @param updatingUser right checks are done for this user
     * @throws PTException in case addition was not successful for any reason
     *         (not enough rights, patient already has a family, etc.)
     */
    void addMember(Family family, Patient patient, User updatingUser) throws PTException;

    /**
     * Removes the given patient form the family.
     *
     * TODO: it is questionable where this method should be located, given new entities API.
     *
     ...
     * @param updatingUser right checks are done for this user
     * @throws PTException if removal was not successful for anyh reason (not enough rights,
     *         patient not a member of this family, etc.)
     */
    ...
    *
    * The famly document is saved to disk after permissions are updated.
    *
    * @param family the family
    */

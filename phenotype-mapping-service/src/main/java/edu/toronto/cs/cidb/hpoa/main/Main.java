...
import edu.toronto.cs.cidb.hpoa.annotation.PrettyPrint;
...
public class Main {
	public static void main(String[] args) {
		...
		System.out.println();
		ICPredictor predictor = new ICPredictor(ann);
		final int LIMIT = 5;
		...
		double matchScore = predictor.asymmetricPhenotypeSimilarity(phenotypes,
				ann.getPhenotypesWithAnnotation("OMIM:152700").keySet());
		System.out.println(matchScore);
		System.out.println(ann.getAnnotationNode("OMIM:152700"));

		List<SearchResult> presults = predictor
